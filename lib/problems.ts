...

{
  ...
  notes: String.raw`Key idea: use $\cos(2x)=(\cos x-\sin x)(\cos x+\sin x)$ to cancel the denominator, leaving $\cos x+\sin x$. Result: $1$.`,
  videoUrl: "",
...
},
{
  ...
  notes: String.raw`Key idea: rewrite in $\sin x,\cos x$, apply the symmetry $x\mapsto\frac{\pi}{2}-x$, and reduce to $\int_0^{\pi/2}\frac{dx}{\sin x+\cos x}$. Result: $\frac14+\sqrt2\ln(1+\sqrt2)$.`,
  videoUrl: "",
  tags: ["symmetry", "trig", "log"],
},
{
  ...
  notes: String.raw`Key idea: split $\frac{1}{x^2(1+x^2)}=\frac{1}{x^2}-\frac{1}{1+x^2}$ and use standard sine and cosine integrals. Result: $\frac{\pi}{2e}$.`,
  videoUrl: "",
  tags: ["improper-integral", "integration-by-parts", "fourier"],
},
{
  slug: "2025-09-18-medium-integral",
  date: "2025-09-18",
  ...
  notes: String.raw`Key idea: substitute $t=e^x$ to obtain $\int_1^3\frac{dt}{t^2+t+1}$, which evaluates via an arctangent after completing the square. Result: $\frac{2}{\sqrt3}\arctan\!\left(\frac{1}{2\sqrt3}\right)$.`,
  videoUrl: "",
...
},
{
  ...
  notes: String.raw`Key idea: rewrite as $1-\frac{x^2}{x^4+x^2+1}$ and factor the denominator into $(x^2+x+1)(x^2-x+1)$ to integrate via symmetric partial fractions. Result: $1+\frac{\ln 3}{4}-\frac{\pi}{4\sqrt3}$.`,
  videoUrl: "",
